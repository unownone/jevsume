/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: f39b88a2b0de6c82227b23ee4c9d564d)
...
interface __BaseEnv_CloudflareBindings {
	...
	DB: D1Database;
	RATE_LIMIT_RESUME_REVIEW: RateLimit;
	RATE_LIMIT_PERSONA_CREATION: RateLimit;
	RATE_LIMIT_RESUME_STORE: RateLimit;
	RATE_LIMIT_VISITOR: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TYPESAFE_MODEL" | "TYPESAFE_BASE_URL">> {}
}
